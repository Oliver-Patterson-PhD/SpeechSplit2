...
class GeneratorF0(nn.Module):
    def __init__(
        ...
        super().__init__()
        self.decoder = DecoderF0(config)
        self.encoder_2 = EncoderRhythm(config)
        self.encoder_3 = EncoderF0(config)
        self.freq_2 = config.model.freq_2
        self.freq_3 = config.model.freq_3
    ...
    def forward(
        ...
        codes_2 = self.encoder_2(x_2, None)
        code_exp_2 = codes_2.repeat_interleave(self.freq_2, dim=-2)
        x_3 = f0_trg.transpose(-1, -2)
        codes_3 = self.encoder_3(x_3, rr=rr)
        code_exp_3 = codes_3.repeat_interleave(self.freq_3, dim=-2)
